...
generateCMPTests('ketch', [
    ...
    // Banner where the reject button occupies the *secondary* slot
    // ('Reject Optional Cookies') and tertiary is 'Cookie Settings'.
    // Ensures the rule identifies reject by aria-label, not by ID slot.
