...
export default class AppGdpr extends AutoConsentBase {
  ...
  async detectPopup(tab) {
    return !await tab.elementExists('div[class*="banner_hidden-"]')
      && await tab.elementExists('div[class*="popup_popup-"],div[class*="banner_banner-')
      && this.detectCmp(tab);
  }
